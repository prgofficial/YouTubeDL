        ...
        StringFileInfo(
            [
                StringTable(
                    "040904B0",
                    [
                        StringStruct("Comments", "Youtube-dl_x86 Command Line Interface."),
                        StringStruct("CompanyName", "theidel@uni-bremen.de"),
                        StringStruct("FileDescription", FILE_DESCRIPTION),
                        StringStruct("FileVersion", version),
                        StringStruct("InternalName", "youtube-dl_x86"),
                        StringStruct(
                            "LegalCopyright",
                            "theidel@uni-bremen.de | UNLICENSE",
                        ),
                        StringStruct("OriginalFilename", "youtube-dl_x86.exe"),
                        StringStruct("ProductName", "Youtube-dl_x86"),
...
SetVersion('dist/youtube-dl_x86.exe', version_file)
