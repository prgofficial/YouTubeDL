...
# response = urllib.request.urlopen('https://blackjack4494.github.io/youtube-dl/update/LATEST_VERSION')
...
file_version_py = open('youtube_dl/version.py', 'rt')
data = file_version_py.read()
data = data.replace(locals()['__version__'], version)
file_version_py.close()
file_version_py = open('youtube_dl/version.py', 'wt')
